...
just send an email with the subject **hello** (case-insensitive) to the mailbox watched by `[imap_server]`, and p2poolmail will reply with a full statistics report.
Emails with any other subject are ignored.
